...
def fetch_and_stream_data(spark, access_token):
    user_id = '122111813636465928'  # Update with your user ID
    while True:
...
if __name__ == "__main__":
    ...
    access_token = 'EAAQqx6wQ7uIBO4IbnGNZCwSpJpEuEMqvB23IVRsqjMMRT8kE3KKCmnw49yXh7l68ulVUt3umSh51pcZBBa33ZCwkXun9SDBogzVOzsA12zFm5lZChSExOozvMuIiP2RYguF96TYq9qicTffDKrQY8CQwSvhmARoOdEI711FOZBC7SjkMUlxxBVAMzxiajf9TT3iI7jK7sxtZASMADlZBqADwdxVZBgZDZD'# Update with your token
